...
* __formatBeforePublishAlt__: Same like __formatBeforePublish__ but in case of a rollshutter you might need a String transformation as well as decimal transformation (STOP command or goto posotion 100)
